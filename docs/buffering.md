...
- [`notebook/buffered_polygon_demo.ipynb`](https://github.com/Khoshkhah/h3-boundary/blob/master/notebook/buffered_polygon_demo.ipynb) reproduces the containment table and the map above; `docs/generate_buffering_figure.py` regenerates the figure.
