...
| …as integers, same order | `boundary_cell_ids(sort=True)` | Much faster; skips string formatting |
...
See it on a map in [`notebook/demo_generation.ipynb`](https://github.com/Khoshkhah/h3-boundary/blob/master/notebook/demo_generation.ipynb). The comparison in this page is reproducible:
